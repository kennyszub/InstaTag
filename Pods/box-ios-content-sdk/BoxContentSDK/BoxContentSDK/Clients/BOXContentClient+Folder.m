...
#import "BOXPaginatedItemArrayRequest.h"
...
- (BOXPaginatedItemArrayRequest *)folderItemsRequestWithID:(NSString *)folderID
                                                   inRange:(NSRange)range
{
    BOXPaginatedItemArrayRequest *request = nil;
    request = [[BOXPaginatedItemArrayRequest alloc] initWithFolderID:folderID inRange:range];
    [self prepareRequest:request];
